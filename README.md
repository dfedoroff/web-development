...
В этом репозитории хранятся решения, упражнения, домашние задания по веб-вёрстке HTML/CSS, выполненные во время прохождения курса по программированию на образовательной онлайн-платформе GeekBrains.
